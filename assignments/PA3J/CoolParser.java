...
// Fri Jan 28 23:59:08 CET 2022
//----------------------------------------------------

import java_cup.runtime.*;

/** CUP v0.11a beta 20060608 generated parser.
  * @version Fri Jan 28 23:59:08 CET 2022
  */
public class CoolParser extends java_cup.runtime.lr_parser {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\002\007\002\000\002\014\003\000\002\014\006\000" +
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\067\000\004\004\007\001\002\000\006\002\001\004" +
    "\007\001\002\000\004\002\070\001\002\000\006\002\uffff" +
    ...
    "\002\ufffc\004\ufffc\001\002\000\004\055\062\001\002\000" +
    ...
    "\001\002\000\004\050\036\001\002\000\012\050\037\051" +
    "\uffee\052\041\056\040\001\002\000\014\043\uffee\050\037" +
    "\051\uffee\052\041\056\040\001\002\000\016\042\ufff1\043" +
    "\ufff1\045\045\046\ufff1\051\ufff1\056\ufff1\001\002\000\014" +
    "\042\ufff2\043\ufff2\046\ufff2\051\ufff2\056\ufff2\001\002\000" +
    "\004\051\043\001\002\000\004\043\044\001\002\000\006" +
    "\051\ufff9\056\ufff9\001\002\000\014\042\uffee\046\uffee\050" +
    "\037\052\041\056\040\001\002\000\004\046\053\001\002" +
    "\000\006\042\051\046\uffe9\001\002\000\004\046\uffea\001" +
    "\002\000\014\042\uffee\046\uffee\050\037\052\041\056\040" +
    "\001\002\000\004\046\uffe8\001\002\000\014\042\ufff0\043" +
    "\ufff0\046\ufff0\051\ufff0\056\ufff0\001\002\000\006\043\056" +
    "\051\057\001\002\000\006\043\uffed\051\uffed\001\002\000" +
    "\012\043\uffee\050\037\052\041\056\040\001\002\000\014" +
    "\042\uffef\043\uffef\046\uffef\051\uffef\056\uffef\001\002\000" +
    "\004\043\061\001\002\000\006\043\uffec\051\uffec\001\002" +
    "\000\010\023\063\051\ufff7\056\ufff7\001\002\000\012\050" +
    "\037\051\uffee\052\041\056\040\001\002\000\006\051\ufff8" +
    "\056\ufff8\001\002\000\006\051\066\056\017\001\002\000" +
    "\004\043\067\001\002\000\006\002\ufffd\004\ufffd\001\002" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\067\000\010\002\004\003\003\004\005\001\001\000" +
    ...
    "\002\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\004\007\041\001\001\000\006\007\054\014" +
    "\053\001\001\000\002\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\010\007" +
    "\046\012\045\013\047\001\001\000\002\001\001\000\002" +
    "\001\001\000\002\001\001\000\006\007\046\013\051\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\004\007\057\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\004\007\063\001\001\000\002\001\001\000\004\006" +
  ...
  public final java_cup.runtime.Symbol CUP$CoolParser$do_action(
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$CoolParser$act_num)
        {
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 25: // exprs ::= expr COMMA exprs 
            {
		...
		Expressions es = (Expressions)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
		 RESULT = es.appendElement(e); 
              CUP$CoolParser$result = parser.getSymbolFactory().newSymbol("exprs",9, RESULT);
            }
		...
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
		 RESULT = new Expressions(curr_lineno()).appendElement(e); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 23: // exprs_opt ::= exprs 
            {
              Expressions RESULT =null;
		Expressions es = (Expressions)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
		 RESULT = es; 
              CUP$CoolParser$result = parser.getSymbolFactory().newSymbol("exprs_opt",8, RESULT);
            }
          return CUP$CoolParser$result;
		 ...
		 RESULT = new Expressions(curr_lineno()); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 21: // expr_semi_list ::= expr_semi_list SEMI expr SEMI 
            {
              Expressions RESULT =null;
		Expressions esl = (Expressions)((java_cup.runtime.Symbol) CUP$CoolParser$stack.elementAt(CUP$CoolParser$top-3)).value;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$CoolParser$stack.elementAt(CUP$CoolParser$top-1)).value;
		 RESULT = esl.appendElement(e); 
              CUP$CoolParser$result = parser.getSymbolFactory().newSymbol("expr_semi_list",10, RESULT);
            }
          return CUP$CoolParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 20: // expr_semi_list ::= expr 
            {
              Expressions RESULT =null;
		Expression e = (Expression)((java_cup.runtime.Symbol) CUP$CoolParser$stack.peek()).value;
		 RESULT = new Expressions(curr_lineno()).appendElement(e); 
		 ...
		 RESULT = (new no_expr(curr_lineno())); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 18: // expr ::= LBRACE expr_semi_list RBRACE 
            {
              Expression RESULT =null;
		Expressions esl = (Expressions)((java_cup.runtime.Symbol) CUP$CoolParser$stack.elementAt(CUP$CoolParser$top-1)).value;
		 RESULT = new block(curr_lineno(),esl); 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 17: // expr ::= OBJECTID LPAREN exprs_opt RPAREN 
            {
              Expression RESULT =null;
